    ...
    \catagory{Experience}
		...
		\item
						...
						Skills used: time series data, EDA, data cleaning and processing, algorithm development, C\#, C++, C, .Net Framework, XML, XSLT, HTML, Javascript, Matlab
		...
		\item
							...
							Skills used: genetic algorithms, gradient descent, time series data, EDA, data cleaning and processing, algorithm development, C++, C, C\#, .Net Framework, XML, XSLT, QT, multithreading, Matlab, HTML, Javascript, team leading, computational mechanics, computational dynamics
