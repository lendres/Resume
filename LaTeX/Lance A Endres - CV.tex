    ...
    \catagory{Projects}
		...
		\project{Three Dimensionsal Bit Dynamics}{
			Create a computer model that matches simulation performace to laboratory data.
		}{
		...
		\project{AllLife Bank Credit Card Customer Segmentation}{
			Identify different segments of customers based on their spending patterns and bank interactions by using clustering algorithms.
			}{
			EDA, k-means clustering, hierarchical clustering, cluster Profiling
		}
		...
		\project{Credit Card Churn Prediction}{
			...
			cross validation, regularization, pipelines, hyperparameter tuning, up sampling, down sampling
		}
		

			
		\project{Travel Package Purchase Prediction}{
			A travel company dataset was used to analyze the customers' information and build a model to predict potential customers who are going to 
			purchase a newly introduced package.
			}{
			EDA, data preprocessing, customer profiling, Bagging, Random Forest, AdaBoost, Gradient Boosting, XGBoost, Stacking Classifier, GridSearchCV
		}
